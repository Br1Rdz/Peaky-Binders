...
#             :red[SREBF2, DEPDC5, RBX1, TXNRD2, MED15, TANGO2 y TXN2]''')
    ...
    st.markdown('''<div style="text-align: justify; font-family:sans-serif; font-size: 14px;">
            El gráfico de señales muestra las regiones donde la cromatina está accesible (ATAC-seq), siendo las señales más altas indicativas de mayor accesibilidad.
            Además, permite identificar sitios donde se unen proteínas específicas, como factores de transcripción o histonas modificadas (ChIP-seq).
            <br>
